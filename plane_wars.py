...
pygame.time.set_timer(CREATE_BOMB_SUPPLY,50000)
...
start_bottom = pygame.image.load("./p/pi/me1.png")
start_bottom_rect = pygame.rect.Rect(240 - 60, 470,102,126)
...
next_surface = start_font.render('NEXT',
                                 True,RED)
text10_surface = start_font.render('press the plane to play!',
                                   True,BLUE)
...
def start_cartoon():
    ...
    while True:
        ...
        back.blit(start, (0, 0))
        back.blit(start_bottom, (240 - 60, 470))
        back.blit(game_over_bottom,game_over_bottom_rect)
        back.blit(text10_surface,(0,0))
        ...
        for Event in pygame.event.get():
            ...
            if Event.type == pygame.MOUSEBUTTONUP:
                ...
                if start_bottom_rect.collidepoint(mousex1, mousey1):
                    return
            # 按钮按下
            if Event.type == pygame.MOUSEBUTTONUP:
            ...
            if Event.type == CREATE_BULLET:
                ...
                bullet1.rect.x = me1.rect.centerx - 45
                ...
                bullet2 = Bullet("./p/pi/bullet2.png",
                                 ...
                                 width=BULLET_WIDTH,
                                 height=BULLET_HEIGHT)
                bullet2.rect.x = me1.rect.centerx + 20
                bullet2.rect.y = me1.rect.y

                bullet_group1.add(bullet1,bullet2)

        bullet_group1.update()
        bullet_group1.draw(back)
        pygame.display.update()
        clock.tick(60)
...
me1 = Me("./p/pi/me1.png",
         speed=0,
         x=MEX,y=MEY,
         width=ME_WIDTH,height=ME_HEIGHT)
me_group = pygame.sprite.Group(me1)

bg1 = Background("./p/pi/background.png",
                 width=BACK_WIDTH,height=BACK_HEIGHT)
bg2 = Background("./p/pi/background.png",
                 x=0,y=-BACK_HEIGHT,
                 width=BACK_WIDTH,height=BACK_HEIGHT)
...
exit_surface = exit_font.render('exit',
                                True,WHITE)
...
game_over_bottom_rect = pygame.rect.Rect(0,0,
                                         game_over_bottom_width,
                                         game_over_bottom_height)
...
bomb_rect = pygame.rect.Rect(0,BACK_HEIGHT - bomb_height,
...
def main_game():
    ...
    while True:
        ...
        bomb_surface = bomb_font.render('X' + str(bomb_num),
                                        True, WHITE)
